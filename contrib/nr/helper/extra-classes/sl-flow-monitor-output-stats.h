 ...
 *
 */
#ifndef SL_FLOW_MONITOR_OUTPUT_STATS_H
#define SL_FLOW_MONITOR_OUTPUT_STATS_H
 ...
 * \see Save
 */
class SlFlowMonitorOutputStats
{
public:
  /**
   * \brief SlFlowMonitorOutputStats constructor
   */
  SlFlowMonitorOutputStats ();
