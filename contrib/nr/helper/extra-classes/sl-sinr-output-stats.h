 ...
 *
 */
#ifndef SL_SINR_OUTPUT_STATS_H
#define SL_SINR_OUTPUT_STATS_H
...
private:
  ...
  struct SlSinrResultCache
  {
//    SlSinrResultCache (uint16_t c, uint16_t b, uint16_t r, double s)
