...
#ifndef SL_CONTRIB_HELPER_MAC_RLC_BUFFER_STATUS_H_
#define SL_CONTRIB_HELPER_MAC_RLC_BUFFER_STATUS_H_
...
class SlMacBsrStats{
   ...
   * Seed/Run pair.
   */
  void SetDb (SQLiteOutput *db, const std::string& tableName = "macBsr", uint32_t writeSize = 100000);
   ...
   * \param [in] tb Tb size
   */
  void SaveSlMacBsrStats (SfnSf sfnSf, uint16_t cellId, uint16_t rnti, 
