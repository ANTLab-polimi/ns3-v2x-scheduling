...
main (int argc, char *argv[])
{
  ...
  PPBPHelper2 ppbp = PPBPHelper2 ("ns3::UdpSocketFactory",
                       InetSocketAddress (interfaces.GetAddress (1),socketPort), InetSocketAddress (interfaces.GetAddress (1),socketPort+1));
