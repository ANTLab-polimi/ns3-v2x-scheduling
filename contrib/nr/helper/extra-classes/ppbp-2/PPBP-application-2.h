...
namespace ns3 {
	...
	class PPBPApplication2 : public Application
	{
	public:
	...
	private:
		...
		// modified 
		// The data for the second user
		Ptr<Socket>     m_socket2;
		Address         m_peer2;
		bool            m_connected2;
		// end modification

		uint32_t        m_totalBytes1;					// Total bytes sent so far
		uint32_t        m_totalBytes2;					// Total bytes sent so far
