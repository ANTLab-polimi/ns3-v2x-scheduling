...
SlFlowMonitorOutputStats::SlFlowMonitorOutputStats ()
{
}
...
SlFlowMonitorOutputStats::SetDb (SQLiteOutput *db, const std::string &tableName)
{
  ...
  SlFlowMonitorOutputStats::DeleteWhere (m_db, RngSeedManager::GetSeed (),
...
void
SlFlowMonitorOutputStats::Save (const Ptr<FlowMonitor> &monitor,
...
void
SlFlowMonitorOutputStats::DeleteWhere (SQLiteOutput *p, uint32_t seed,
