 ...
 *
 */
#ifndef SL_SLOT_OUTPUT_STATS_H
#define SL_SLOT_OUTPUT_STATS_H
...
public:
   ...
   * Seed/Run pair.
   */
  void SetDb (SQLiteOutput *db, const std::string& tableName = "slotStats", uint32_t writeSize = 100000);
