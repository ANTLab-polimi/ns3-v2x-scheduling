...
std::string
NrSlMacPduTag::GetString(){
  return std::to_string(m_rnti) + \
     "," + std::to_string(m_dstL2Id) + \
     "," + std::to_string(m_sfnSf.GetFrame ())+ \
     "," + std::to_string(m_sfnSf.GetSubframe ())+ \
     "," + std::to_string(m_sfnSf.GetSlot ())+ \
     "," + std::to_string(m_symStart)+ \
     "," + std::to_string(m_numSym)+ \
     "," + std::to_string(m_tbSize);
}
