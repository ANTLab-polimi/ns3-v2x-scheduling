...
protected:
   ...
   * \param params NrSlMacSapProvider::NrSlReportBufferStatusParameters
   */
  void DoReportNrSlPacketDelayStatus (uint16_t packetSeqNumber, uint64_t waitingSince, uint32_t numPackets, uint32_t queueSize, uint16_t rnti, const NrSlMacSapProvider::NrSlReportBufferStatusParameters &params);
