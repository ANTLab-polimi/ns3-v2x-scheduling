...
public:
  ...
  // modified
  virtual void ReportNrSlPacketDelayStatus (uint16_t packetSeqNumber, uint64_t waitingSince, uint32_t numPackets, uint32_t queueSize, uint16_t rnti, const NrSlReportBufferStatusParameters& params) = 0;
  // end modification
};
...
public:
  ...
  // modified
  virtual void ReportNrSlPacketDelayStatus (uint16_t packetSeqNumber, uint64_t waitingSince, uint32_t numPackets, uint32_t queueSize, uint16_t rnti, const NrSlReportBufferStatusParameters& params);
  // end modification
...
// modified
template <class C>
void MemberNrSlMacSapProvider<C>::ReportNrSlPacketDelayStatus (uint16_t packetSeqNumber, uint64_t waitingSince, uint32_t numPackets, uint32_t queueSize, uint16_t rnti, const NrSlReportBufferStatusParameters& params)
{
  m_mac->DoReportNrSlPacketDelayStatus (packetSeqNumber, waitingSince, numPackets, queueSize, rnti, params);
}
